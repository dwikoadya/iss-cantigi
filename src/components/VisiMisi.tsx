...
export default function VisiMisi({ site_name }: ISiteName) {
  return (
    <div className="flex bg-light text-center items-center text-white flex-col">
      <div className="flex flex-col text-center tracking-wider lg:text-2xl px-4 lg:px-0">
        <h3 className="font-bold lg:text-4xl text-2xl lg:my-14 my-8">{`Visi ${site_name}`}</h3>
      ...
      <div className="flex flex-col justify-center items-center lg:mt-24 mt-12">
        <h3 className="font-bold text-center lg:text-4xl text-2xl">{`Misi ${site_name}`}</h3>
