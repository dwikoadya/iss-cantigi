...
export default function ApbDesa() {
  return (
    <div className="bg-red-800 text-center md:py-24 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-around md:max-w-screen-lg w-[90%] mx-auto gap-8">
        {
          button.map((item) => (
            <button className="rounded-lg bg-white text-red-800 font-bold md:py-4 md:px-16 lg:px-24 py-2 px-8 text-lg" key={item} type="button">
              {item}
            </button>
          ))
        }
